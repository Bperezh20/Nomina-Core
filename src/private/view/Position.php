        ...
        <div class="container-fluid">
            ...
            <form class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-xl-6 col-md-6 mb-6 position-relative input-group-md">
                        ...
                        <input type="text" class="form-control" id="puesto" placeholder="Mantenimiento" required>
                    </div>
                    <div class="col-xl-6 col-md-6 mb-6 position-relative input-group-md">
                        <label for="departamento" class="form-label">Departamento</label>
                        <input type="text" class="form-control" id="departamento" placeholder="10" required>
                    </div>
                    <div class="col-xl-6 col-md-6 mb-6 position-relative input-group-md mt-2">
                        <label for="reportTo" class="form-label">A quien reporta</label>
                        <input type="text" class="form-control" id="reportTo" placeholder="10">
                    </div>
                    <div class="col-xl-6 col-md-6 mb-6 position-relative input-group-md mt-2">
                    ...
                    <div class="col-xl-6 col-md-6 mb-6 justify-content-center mt-3">
                        <label for="depDesc" class="form-label">Describa brevemente la funcion del puesto</label>
                        <textarea class="form-control" id="depDesc" placeholder="Este puesto cumple con el proposito..."></textarea>
                    </div>
                </div>
                <br>
            ...
            <div class="row justify-content-end">
                <div class="col-xl-5 col-md-5 mb-12">
                    <input type="text" class="form-control" placeholder="Buscar por: Puesto ó Departamento">
                </div>
            </div>
