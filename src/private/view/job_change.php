    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Cambio de Puesto</h1>
            </div>
            ...
            <form class="needs-validation" novalidate>
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 mb-6 position-relative input-group-md">
                        <label for="departamento" class="form-label">Nombre Puesto Nuevo</label>
                        <input type="text" class="form-control" id="departamento" placeholder="Contabilidad" required>
                    </div>
                    ...
                    <div class="col-xl-6 col-md-6 mb-6 justify-content-center mt-3">
                        <label for="depDesc" class="form-label">Describa brevemente las funciones del nuevo puesto</label>
